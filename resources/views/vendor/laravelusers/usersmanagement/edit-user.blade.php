      ...
      <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-default">
          <div class="panel-heading">
            ...
            <strong>Editando Usuario:</strong> {{ $user->name }}
            ...
            <a href="/users" class="btn btn-info btn-xs pull-right">
              <i class="fa fa-fw fa-mail-reply" aria-hidden="true"></i>
              <span class="hidden-xs">Volver a </span>Usuarios
            </a>
          ...
          {!! Form::model($user, array('action' => array('\jeremykenedy\laravelusers\app\Http\Controllers\UsersManagementController@update', $user->id), 'method' => 'PUT')) !!}
			...
			<!--  <div class="form-group has-feedback row">
                {!! Form::label('run', 'run' , array('class' => 'col-md-3 control-label')); !!}
                <div class="col-md-9">
                  <div class="input-group">
                    {!! Form::text('run', old('run'), array('id' => 'run', 'class' => 'form-control', 'placeholder' => Lang::get('forms.ph-userrun'))) !!}
                    <label class="input-group-addon" for="run"><i class="fa fa-fw fa-vcard }}" aria-hidden="true"></i></label>
                  </div>
                </div>
              </div>
-->
