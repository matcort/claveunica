        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            ...
            <a href="/users" class="btn btn-info btn-xs pull-right">
              ...
              <span class="hidden-sm hidden-xs">Volver a </span><span class="hidden-xs">Usuarios</span>
            </a>
          ...
          <div class="panel-body">
            ...
            {!! Form::open(array('action' => '\jeremykenedy\laravelusers\app\Http\Controllers\UsersManagementController@store', 'method' => 'POST', 'role' => 'form')) !!}
              ...
              <div class="form-group has-feedback row">
                {!! Form::label('run', Lang::get('forms.create_user_lavel_run'), array('class' => 'col-md-3 control-label')); !!}
                <div class="col-md-9">
                  <div class="input-group">
                    {{!! Form::text('run', NULL, array('id' => 'run', 'class' => 'form-control', 'placeholder' => Lang::get('forms.create_user_ph_run'))) !!}
                    <label class="input-group-addon" for="run"><i class="fa fa-fw {{ Lang::get('forms.create_user_icon_username') }}" aria-hidden="true"></i></label>
                  </div>
                </div>
              </div>
